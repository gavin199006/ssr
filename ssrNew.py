...
def ssr(stri):
	...
	dictList = ["server", "sever_ipv6", "server_port", "local_address", "local_port", "password", "timeout", "method",
	            "protocol", "obfs", "obs_param", "redirect", "dns_ipv6", "fast_open", "workers"]
	result = '{' + '\n'
	for key in dictList:
